...
export CLANG_PATH=/data/moinak/Kirisakura/linux-x86/clang-r383902b/bin
...
export LD_LIBRARY_PATH=/data/moinak/Kirisakura/linux-x86/clang-r383902b/lib64:$LD_LIBRARY_PATH
